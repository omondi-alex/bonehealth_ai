...
export default function Overview() {
  return (
    <div className="space-y-8 max-w-3xl mx-auto bg-white bg-opacity-95 rounded-2xl shadow-2xl p-10">
      <h1 className="text-3xl font-bold mb-4 text-green-800">Overview: Osteoporosis Risk Assessment Model</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-8">
        <div className="bg-violet-50 rounded-xl p-6 shadow flex flex-col justify-between">
          <h2 className="text-lg font-bold text-violet-800 mb-2">Model Purpose & Utility</h2>
        ...
        <div className="bg-green-50 rounded-xl p-6 shadow flex flex-col justify-between">
          <h2 className="text-lg font-bold text-green-800 mb-2">Overall Model Performance (Mock Data)</h2>
          <div className="text-gray-800 mb-1">Overall Accuracy: <span className="font-bold text-green-700">87%</span></div>
          <div className="text-gray-800 mb-2">Area Under ROC Curve (AUC): <span className="font-bold text-green-700">0.89</span></div>
          <div className="text-xs text-gray-500">*These are illustrative values for demonstration purposes.</div>
        </div>
      </div>
      <div className="bg-gray-50 rounded-xl p-6 shadow">
        <h2 className="text-lg font-bold text-gray-800 mb-2">Key Feature Insights (Mock Data)</h2>
        <ul className="list-disc pl-5 text-gray-800 space-y-1">
